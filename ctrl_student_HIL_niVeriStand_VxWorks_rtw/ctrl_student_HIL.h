...
typedef struct {
  ...
  real_T U_vsp;                        /* '<S3>/MATLAB Function' */
  real_T U_bt;                         /* '<S3>/MATLAB Function' */
  real_T alpha;                        /* '<S3>/MATLAB Function' */
  real_T omega;                        /* '<S3>/MATLAB Function' */
 ...
 * '<S3>'   : 'ctrl_student_HIL/Thrust Allocation'
 ...
 * '<S14>'  : 'ctrl_student_HIL/Simple Thrust Allocation/MATLAB Function'
 * '<S15>'  : 'ctrl_student_HIL/Thrust Allocation/MATLAB Function'
 */
