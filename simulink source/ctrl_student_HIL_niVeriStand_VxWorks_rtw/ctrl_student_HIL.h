...
typedef struct {
  ...
  real_T WhiteNoise_e;                 /* '<S31>/White Noise' */
  real_T WhiteNoise_m;                 /* '<S29>/White Noise' */
  real_T Hold[3];                      /* '<S25>/Hold' */
  real_T Memory[3];                    /* '<S37>/Memory' */
  real_T Dropout;                      /* '<S7>/Drop-out' */
  real_T Memory_c[3];                  /* '<S7>/Memory' */
  ...
  real_T Integrator1_k;                /* '<S3>/Integrator1' */
  real_T pathNumber;                   /* '<S15>/ pathNumber' */
  real_T IC[3];                        /* '<S16>/IC' */
  real_T IC1[3];                       /* '<S16>/IC1' */
  real_T my;                           /* '<S19>/my' */
  real_T Memory_a;                     /* '<S19>/Memory' */
  ...
  real_T MatrixMultiply9[3];           /* '<S32>/Matrix Multiply9' */
  real_T MatrixMultiply4[3];           /* '<S6>/Matrix Multiply4' */
  real_T Sum1_g[3];                    /* '<S6>/Sum1' */
  real_T L2_continuous;                /* '<S23>/L2_continuous' */
  real_T PosXRight;                    /* '<S23>/PosXRight' */
  real_T PosYRight;                    /* '<S23>/PosYRight' */
  real_T R2_continuous;                /* '<S23>/R2_continuous' */
  real_T PosXLeft;                     /* '<S23>/PosXLeft' */
  real_T PosYLeft;                     /* '<S23>/PosYLeft' */
  real_T L1;                           /* '<S23>/L1' */
  real_T R1;                           /* '<S23>/R1' */
  real_T ArrowDown;                    /* '<S23>/ArrowDown' */
  real_T ArrowUp;                      /* '<S23>/ArrowUp' */
  real_T ArrowLeft;                    /* '<S23>/ArrowLeft' */
  real_T ArrowRight;                   /* '<S23>/ArrowRight' */
  real_T eta_m_out[3];                 /* '<S7>/Signal drop-out simulation' */
  real_T eta_m_c1[3];                  /* '<S37>/MATLAB Function' */
  real_T output[3];                    /* '<S25>/MATLAB Function1' */
  real_T count;                        /* '<S24>/MATLAB Function' */
  real_T s_dot;                        /* '<S19>/s calculation' */
...
typedef struct {
  ...
  real_T counter_PreviousInput;        /* '<S24>/counter' */
  real_T niose_power_DWORK1;           /* '<Root>/niose_power' */
  real_T NextOutput;                   /* '<S30>/White Noise' */
  real_T NextOutput_c;                 /* '<S31>/White Noise' */
  real_T NextOutput_p;                 /* '<S29>/White Noise' */
  real_T Hold_PreviousInput[3];        /* '<S25>/Hold' */
  real_T Memory_PreviousInput[3];      /* '<S37>/Memory' */
  real_T Dropout_DWORK1;               /* '<S7>/Drop-out' */
  real_T Memory_PreviousInput_l[3];    /* '<S7>/Memory' */
  ...
  real_T pathNumber_DWORK1;            /* '<S15>/ pathNumber' */
  real_T IC_FirstOutputTime;           /* '<S16>/IC' */
  real_T IC1_FirstOutputTime;          /* '<S16>/IC1' */
  real_T my_DWORK1;                    /* '<S19>/my' */
  real_T Memory_PreviousInput_la;      /* '<S19>/Memory' */
  ...
  real_T ControlleroutputX_DWORK1;     /* '<S12>/Controller output X' */
  real_T ControlleroutputY_DWORK1;     /* '<S12>/Controller output Y' */
  real_T ControlleroutputPSI_DWORK1;   /* '<S12>/Controller output PSI' */
  real_T nu_x_hat_DWORK1;              /* '<S35>/ nu_x_hat' */
  real_T nu_y_hat_DWORK1;              /* '<S35>/ nu_y_hat' */
  real_T nu_psi_hat_DWORK1;            /* '<S35>/nu_psi_hat' */
  real_T L2_continuous_DWORK1;         /* '<S23>/L2_continuous' */
  real_T PosXRight_DWORK1;             /* '<S23>/PosXRight' */
  real_T PosYRight_DWORK1;             /* '<S23>/PosYRight' */
  real_T R2_continuous_DWORK1;         /* '<S23>/R2_continuous' */
  real_T PosXLeft_DWORK1;              /* '<S23>/PosXLeft' */
  real_T PosYLeft_DWORK1;              /* '<S23>/PosYLeft' */
  real_T L1_DWORK1;                    /* '<S23>/L1' */
  real_T R1_DWORK1;                    /* '<S23>/R1' */
  real_T ArrowDown_DWORK1;             /* '<S23>/ArrowDown' */
  real_T ArrowUp_DWORK1;               /* '<S23>/ArrowUp' */
  real_T ArrowLeft_DWORK1;             /* '<S23>/ArrowLeft' */
  real_T ArrowRight_DWORK1;            /* '<S23>/ArrowRight' */
  struct {
    void *LoggedData;
  } s_PWORK;                           /* '<S3>/s' */
  ...
  uint32_T RandSeed_j;                 /* '<S31>/White Noise' */
  uint32_T RandSeed_c;                 /* '<S29>/White Noise' */
  struct {
    int_T IcNeedsLoading;
  } Integrator2_IWORK;                 /* '<S6>/Integrator2' */
  ...
  uint8_T pathNumber_DWORK2[17];       /* '<S15>/ pathNumber' */
  uint8_T my_DWORK2[17];               /* '<S19>/my' */
  ...
  uint8_T ControlleroutputX_DWORK2[17];/* '<S12>/Controller output X' */
  uint8_T ControlleroutputY_DWORK2[17];/* '<S12>/Controller output Y' */
  uint8_T ControlleroutputPSI_DWORK2[17];/* '<S12>/Controller output PSI' */
  uint8_T nu_x_hat_DWORK2[17];         /* '<S35>/ nu_x_hat' */
  uint8_T nu_y_hat_DWORK2[17];         /* '<S35>/ nu_y_hat' */
  uint8_T nu_psi_hat_DWORK2[17];       /* '<S35>/nu_psi_hat' */
  uint8_T L2_continuous_DWORK2[17];    /* '<S23>/L2_continuous' */
  uint8_T PosXRight_DWORK2[17];        /* '<S23>/PosXRight' */
  uint8_T PosYRight_DWORK2[17];        /* '<S23>/PosYRight' */
  uint8_T R2_continuous_DWORK2[17];    /* '<S23>/R2_continuous' */
  uint8_T PosXLeft_DWORK2[17];         /* '<S23>/PosXLeft' */
  uint8_T PosYLeft_DWORK2[17];         /* '<S23>/PosYLeft' */
  uint8_T L1_DWORK2[17];               /* '<S23>/L1' */
  uint8_T R1_DWORK2[17];               /* '<S23>/R1' */
  uint8_T ArrowDown_DWORK2[17];        /* '<S23>/ArrowDown' */
  uint8_T ArrowUp_DWORK2[17];          /* '<S23>/ArrowUp' */
  uint8_T ArrowLeft_DWORK2[17];        /* '<S23>/ArrowLeft' */
  uint8_T ArrowRight_DWORK2[17];       /* '<S23>/ArrowRight' */
...
typedef struct {
  ...
  real_T Integrator_CSTATE_b[3];       /* '<S32>/Integrator' */
...
typedef struct {
  ...
  boolean_T Integrator_CSTATE_b[3];    /* '<S32>/Integrator' */
...
struct P_ctrl_student_HIL_T_ {
  ...
  real_T Dropout_P6;                   /* Expression: btype
                                        * Referenced by: '<S7>/Drop-out'
                                        */
  real_T Memory_X0_l[3];               /* Expression: [0 0 0]
  ...
  real_T my_P6;                        /* Expression: btype
                                        * Referenced by: '<S19>/my'
                                        */
  real_T Memory_X0_e;                  /* Expression: 0.0000001
  ...
  real_T integratorresetmodel_P6;      /* Expression: btype
                                        * Referenced by: '<S10>/integrator reset model'
                                        */
  real_T ControlleroutputX_P1;         /* Expression: width
                                        * Referenced by: '<S12>/Controller output X'
                                        */
  real_T ControlleroutputX_P2;         /* Expression: dtype
                                        * Referenced by: '<S12>/Controller output X'
                                        */
  real_T ControlleroutputX_P3;         /* Expression: portnum
                                        * Referenced by: '<S12>/Controller output X'
                                        */
  real_T ControlleroutputX_P4;         /* Expression: stime
                                        * Referenced by: '<S12>/Controller output X'
                                        */
  real_T ControlleroutputX_P5;         /* Expression: stype
                                        * Referenced by: '<S12>/Controller output X'
                                        */
  real_T ControlleroutputX_P6;         /* Expression: btype
                                        * Referenced by: '<S12>/Controller output X'
                                        */
  real_T ControlleroutputY_P1;         /* Expression: width
                                        * Referenced by: '<S12>/Controller output Y'
                                        */
  real_T ControlleroutputY_P2;         /* Expression: dtype
                                        * Referenced by: '<S12>/Controller output Y'
                                        */
  real_T ControlleroutputY_P3;         /* Expression: portnum
                                        * Referenced by: '<S12>/Controller output Y'
                                        */
  real_T ControlleroutputY_P4;         /* Expression: stime
                                        * Referenced by: '<S12>/Controller output Y'
                                        */
  real_T ControlleroutputY_P5;         /* Expression: stype
                                        * Referenced by: '<S12>/Controller output Y'
                                        */
  real_T ControlleroutputY_P6;         /* Expression: btype
                                        * Referenced by: '<S12>/Controller output Y'
                                        */
  real_T ControlleroutputPSI_P1;       /* Expression: width
                                        * Referenced by: '<S12>/Controller output PSI'
                                        */
  real_T ControlleroutputPSI_P2;       /* Expression: dtype
                                        * Referenced by: '<S12>/Controller output PSI'
                                        */
  real_T ControlleroutputPSI_P3;       /* Expression: portnum
                                        * Referenced by: '<S12>/Controller output PSI'
                                        */
  real_T ControlleroutputPSI_P4;       /* Expression: stime
                                        * Referenced by: '<S12>/Controller output PSI'
                                        */
  real_T ControlleroutputPSI_P5;       /* Expression: stype
                                        * Referenced by: '<S12>/Controller output PSI'
                                        */
  real_T ControlleroutputPSI_P6;       /* Expression: btype
                                        * Referenced by: '<S12>/Controller output PSI'
                                        */
 ...
 * '<S6>'   : 'ctrl_student_HIL/Observer'
 * '<S7>'   : 'ctrl_student_HIL/Signal Drop-out'
 * '<S8>'   : 'ctrl_student_HIL/eta_d to veristand'
 * '<S9>'   : 'ctrl_student_HIL/op_space'
 * '<S10>'  : 'ctrl_student_HIL/tau to CSE mocell (only use for HIL testing)'
 * '<S11>'  : 'ctrl_student_HIL/Controller/MATLAB Function'
 * '<S12>'  : 'ctrl_student_HIL/Controller/VeriStand Output'
 * '<S13>'  : 'ctrl_student_HIL/Gain Matrices/Controller gain matrix k_p2'
 * '<S14>'  : 'ctrl_student_HIL/Gain Matrices/MATLAB Function'
 * '<S15>'  : 'ctrl_student_HIL/Guidance/Control inputs'
 * '<S16>'  : 'ctrl_student_HIL/Guidance/Path generation'
 * '<S17>'  : 'ctrl_student_HIL/Guidance/Rotation matrix'
 * '<S18>'  : 'ctrl_student_HIL/Guidance/XY pos'
 * '<S19>'  : 'ctrl_student_HIL/Guidance/s_dot generation'
 * '<S20>'  : 'ctrl_student_HIL/Guidance/Path generation/Ellipsoid'
 * '<S21>'  : 'ctrl_student_HIL/Guidance/Path generation/straight line'
 * '<S22>'  : 'ctrl_student_HIL/Guidance/s_dot generation/s calculation'
 * '<S23>'  : 'ctrl_student_HIL/Joystick/joystick'
 * '<S24>'  : 'ctrl_student_HIL/Noise generator/Downsample	signal'
 * '<S25>'  : 'ctrl_student_HIL/Noise generator/Sample & hold'
 * '<S26>'  : 'ctrl_student_HIL/Noise generator/noise generator'
 * '<S27>'  : 'ctrl_student_HIL/Noise generator/Downsample	signal/MATLAB Function'
 * '<S28>'  : 'ctrl_student_HIL/Noise generator/Sample & hold/MATLAB Function1'
 * '<S29>'  : 'ctrl_student_HIL/Noise generator/noise generator/Band-limited white noise psi'
 * '<S30>'  : 'ctrl_student_HIL/Noise generator/noise generator/Band-limited white noise x'
 * '<S31>'  : 'ctrl_student_HIL/Noise generator/noise generator/Band-limited white noise y'
 * '<S32>'  : 'ctrl_student_HIL/Observer/Bias estimator'
 * '<S33>'  : 'ctrl_student_HIL/Observer/MATLAB Function'
 * '<S34>'  : 'ctrl_student_HIL/Observer/kinematics'
 * '<S35>'  : 'ctrl_student_HIL/Observer/nu_hat_out'
 * '<S36>'  : 'ctrl_student_HIL/Observer/kinematics/MATLAB Function1'
 * '<S37>'  : 'ctrl_student_HIL/Signal Drop-out/Detection'
 * '<S38>'  : 'ctrl_student_HIL/Signal Drop-out/Signal drop-out simulation'
 * '<S39>'  : 'ctrl_student_HIL/Signal Drop-out/Detection/MATLAB Function'
 */
