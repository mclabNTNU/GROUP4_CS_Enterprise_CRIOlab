...
typedef struct {
  ...
  real_T Memory[3];                    /* '<S22>/Memory' */
  real_T Dropout;                      /* '<S4>/Drop-out' */
  real_T Memory_c[3];                  /* '<S4>/Memory' */
  ...
  real_T L1_11;                        /* '<S1>/L1_11' */
  real_T L3_11;                        /* '<S1>/L3_11' */
  real_T L3_22;                        /* '<S1>/L3_22' */
  real_T L3_33;                        /* '<S1>/L3_33' */
  real_T L2_33;                        /* '<S1>/L2_33' */
  real_T L1_33;                        /* '<S1>/L1_33' */
  real_T L1_22;                        /* '<S1>/L1_22' */
  real_T L2_11;                        /* '<S1>/L2_11' */
  real_T L2_22;                        /* '<S1>/L2_22' */
  real_T MatrixMultiply9[3];           /* '<S17>/Matrix Multiply9' */
  real_T MatrixMultiply4[3];           /* '<S3>/Matrix Multiply4' */
  real_T Sum1[3];                      /* '<S3>/Sum1' */
  real_T eta_m_out[3];                 /* '<S4>/Signal drop-out simulation' */
  real_T eta_m_c1[3];                  /* '<S22>/MATLAB Function' */
...
typedef struct {
  ...
  real_T Memory_PreviousInput[3];      /* '<S22>/Memory' */
  real_T Dropout_DWORK1;               /* '<S4>/Drop-out' */
  real_T Memory_PreviousInput_l[3];    /* '<S4>/Memory' */
  real_T eta_mpsi_DWORK1;              /* '<S4>/eta_mpsi' */
  real_T eta_mx_DWORK1;                /* '<S4>/eta_mx' */
  real_T eta_my_DWORK1;                /* '<S4>/eta_my' */
  ...
  real_T nu_x_hat_DWORK1;              /* '<S20>/ nu_x_hat' */
  real_T nu_y_hat_DWORK1;              /* '<S20>/ nu_y_hat' */
  real_T nu_psi_hat_DWORK1;            /* '<S20>/nu_psi_hat' */
  real_T L1_11_DWORK1;                 /* '<S1>/L1_11' */
  real_T L3_11_DWORK1;                 /* '<S1>/L3_11' */
  real_T L3_22_DWORK1;                 /* '<S1>/L3_22' */
  real_T L3_33_DWORK1;                 /* '<S1>/L3_33' */
  real_T L2_33_DWORK1;                 /* '<S1>/L2_33' */
  real_T L1_33_DWORK1;                 /* '<S1>/L1_33' */
  real_T L1_22_DWORK1;                 /* '<S1>/L1_22' */
  real_T L2_11_DWORK1;                 /* '<S1>/L2_11' */
  real_T L2_22_DWORK1;                 /* '<S1>/L2_22' */
  ...
  } Integrator2_IWORK;                 /* '<S3>/Integrator2' */
  ...
  uint8_T Dropout_DWORK2[17];          /* '<S4>/Drop-out' */
  uint8_T eta_mpsi_DWORK2[17];         /* '<S4>/eta_mpsi' */
  uint8_T eta_mx_DWORK2[17];           /* '<S4>/eta_mx' */
  uint8_T eta_my_DWORK2[17];           /* '<S4>/eta_my' */
  ...
  uint8_T nu_x_hat_DWORK2[17];         /* '<S20>/ nu_x_hat' */
  uint8_T nu_y_hat_DWORK2[17];         /* '<S20>/ nu_y_hat' */
  uint8_T nu_psi_hat_DWORK2[17];       /* '<S20>/nu_psi_hat' */
  uint8_T L1_11_DWORK2[17];            /* '<S1>/L1_11' */
  uint8_T L3_11_DWORK2[17];            /* '<S1>/L3_11' */
  uint8_T L3_22_DWORK2[17];            /* '<S1>/L3_22' */
  uint8_T L3_33_DWORK2[17];            /* '<S1>/L3_33' */
  uint8_T L2_33_DWORK2[17];            /* '<S1>/L2_33' */
  uint8_T L1_33_DWORK2[17];            /* '<S1>/L1_33' */
  uint8_T L1_22_DWORK2[17];            /* '<S1>/L1_22' */
  uint8_T L2_11_DWORK2[17];            /* '<S1>/L2_11' */
  uint8_T L2_22_DWORK2[17];            /* '<S1>/L2_22' */
 ...
 * '<S17>'  : 'ctrl_student_HIL/Observer/Bias estimator'
 * '<S18>'  : 'ctrl_student_HIL/Observer/MATLAB Function'
 * '<S19>'  : 'ctrl_student_HIL/Observer/kinematics'
 * '<S20>'  : 'ctrl_student_HIL/Observer/nu_hat_out'
 * '<S21>'  : 'ctrl_student_HIL/Observer/kinematics/MATLAB Function1'
 * '<S22>'  : 'ctrl_student_HIL/Signal Drop-out/Detection'
 * '<S23>'  : 'ctrl_student_HIL/Signal Drop-out/Signal drop-out simulation'
 * '<S24>'  : 'ctrl_student_HIL/Signal Drop-out/Detection/MATLAB Function'
 */
