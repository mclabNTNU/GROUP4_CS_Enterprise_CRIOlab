...
static void u2pwm_output(void)
{
  ...
  if (u2pwm_B.manualoverride != 0.0) {
    ...
    u2pwm_B.Switch[0] = (u2pwm_B.BT_max_pwm - u2pwm_B.BT_min_pwm) *
      u2pwm_P.Gain5_Gain * rtb_Product11 + (u2pwm_B.BT_max_pwm +
      u2pwm_B.BT_min_pwm);
...
static char* NI_CompiledModelDateTime = "Mon Apr 03 10:08:10 2017";
